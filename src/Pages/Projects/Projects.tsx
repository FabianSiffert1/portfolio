...
export default function Projects() {
    return <div className={styles.projects}>
        <Project projectTitle={"Inventory"}
                 projectDescription={"A simple, Android-only investment tracker.\n\n" +
                     "This is the project I'm currently working on. As of May 2025, it runs on a local database, which I plan to replace in the future. The project hasn't been deployed yet, as it's still a work in progress."}
                 links={[
