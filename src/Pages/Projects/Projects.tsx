...
import { ColorVariant } from './project/colorVariant'
  ...
  return (
    <div className={styles.projects}>
      ...
      <Project
        ...
        projectDescription={
          <>
            A hud for the docker containers running on my local server
            <br />
            <br />
            Build with a{' '}
            <ExternalLink
            ...
            view switching and restarting docker containers. <br />
            <br />
            Vibecoded in Python.
          </>
        }
      ...
      <Project
        ...
        projectDescription={
          <>
            Learning electronics hands-on — multimeter, soldering iron, cheap ESP32-S3 boards — by building things that plug into my Home
            Assistant setup. Everything runs on ESPHome, which turns a microcontroller into a native Home Assistant device from a few lines
            of YAML.
            <br />
            <br />
            <b>Sunrise Alarm</b> — an alarm clock that wakes me with light instead of noise. Currently pulls time, temperature and the alarm
            state from Home Assistant. Next: driving the lamp and leaving the breadboard behind.
            <br />
            <br />
            <b>Grundig Micro-Boy 300</b> — a shortwave pocket radio from the analogue era, brought back to life. The original electronics
            work again, the corroded battery holder is gone, and it now runs off my own power module. <br /> But no German station
            broadcasts on shortwave anymore, so the receiver has nothing left to receive. It gets a second job instead: a Home Assistant
